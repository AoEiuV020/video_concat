...
void main() {
  ...
  group('TrimConfig', () {
    ...
    test('有片段的配置', () {
      final config = TrimConfig(segments: [
    ...
    test('相等性', () {
      final a = TrimConfig(segments: [
        TrimSegment(inpoint: 0, outpoint: 1000000),
      ]);
      final b = TrimConfig(segments: [
        TrimSegment(inpoint: 0, outpoint: 1000000),
      ]);
      expect(a, equals(b));
    });
    ...
    test('不等性：片段不同', () {
      ...
      final b = TrimConfig(segments: [
        TrimSegment(inpoint: 0, outpoint: 2000000),
      ]);
