...
@override
int get hashCode => Object.hash(runtimeType,showOptions,rotation,removeAudio,removeSubtitles,fastStart,stripMetadata,addChapters,rememberChoices);

@override
String toString() {
  return 'ExportOptions(showOptions: $showOptions, rotation: $rotation, removeAudio: $removeAudio, removeSubtitles: $removeSubtitles, fastStart: $fastStart, stripMetadata: $stripMetadata, addChapters: $addChapters, rememberChoices: $rememberChoices)';
}
...
@useResult
$Res call({
 bool showOptions, int? rotation, bool removeAudio, bool removeSubtitles, bool fastStart, bool stripMetadata, bool addChapters, bool rememberChoices
});
...
/// Create a copy of ExportOptions
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? showOptions = null,Object? rotation = freezed,Object? removeAudio = null,Object? removeSubtitles = null,Object? fastStart = null,Object? stripMetadata = null,Object? addChapters = null,Object? rememberChoices = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool showOptions,  int? rotation,  bool removeAudio,  bool removeSubtitles,  bool fastStart,  bool stripMetadata,  bool addChapters,  bool rememberChoices)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ExportOptions() when $default != null:
return $default(_that.showOptions,_that.rotation,_that.removeAudio,_that.removeSubtitles,_that.fastStart,_that.stripMetadata,_that.addChapters,_that.rememberChoices);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool showOptions,  int? rotation,  bool removeAudio,  bool removeSubtitles,  bool fastStart,  bool stripMetadata,  bool addChapters,  bool rememberChoices)  $default,) {final _that = this;
switch (_that) {
case _ExportOptions():
return $default(_that.showOptions,_that.rotation,_that.removeAudio,_that.removeSubtitles,_that.fastStart,_that.stripMetadata,_that.addChapters,_that.rememberChoices);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool showOptions,  int? rotation,  bool removeAudio,  bool removeSubtitles,  bool fastStart,  bool stripMetadata,  bool addChapters,  bool rememberChoices)?  $default,) {final _that = this;
switch (_that) {
case _ExportOptions() when $default != null:
return $default(_that.showOptions,_that.rotation,_that.removeAudio,_that.removeSubtitles,_that.fastStart,_that.stripMetadata,_that.addChapters,_that.rememberChoices);case _:
  return null;
...
class _ExportOptions extends ExportOptions {
  const _ExportOptions({this.showOptions = false, this.rotation = null, this.removeAudio = false, this.removeSubtitles = false, this.fastStart = false, this.stripMetadata = false, this.addChapters = false, this.rememberChoices = false}): super._();
...
/// Create a copy of ExportOptions
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? showOptions = null,Object? rotation = freezed,Object? removeAudio = null,Object? removeSubtitles = null,Object? fastStart = null,Object? stripMetadata = null,Object? addChapters = null,Object? rememberChoices = null,}) {
